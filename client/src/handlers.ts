...
export function updateNav(): void {
  ...
  const sparkleSVG = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="sparkle">
  ...
  if (!isAuthenticated()) {
    authNav.innerHTML = `
      <a href="/register" data-link class="register-button">
        <div class="dots_border"></div>
        ${sparkleSVG}
        <span class="text_button">Register</span>
      </a>
      <a href="/login" data-link class="login-button">
        <div class="dots_border"></div>
        ${sparkleSVG}
    ...
    authNav.innerHTML = `
      <a href="/account" data-link class="account-button">
        <div class="dots_border"></div>
        ${sparkleSVG}
        <span class="text_button">Account</span>
      </a>
      <button id="logoutNavBtn" class="logout-button">
        <div class="dots_border"></div>
        ${sparkleSVG}
        <span class="text_button">Disconnect</span>
      </button>
    `;
